<h1>1229 - Shortest Path with Alternating Colors</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/shortest-path-with-alternating-colors/">shortest-path-with-alternating-colors</a></h2><p>You are given an integer <code>n</code>, the number of nodes in a directed graph where the nodes are labeled from <code>0</code> to <code>n - 1</code>. Each edge is red or blue in this graph, and there could be self-edges and parallel edges.</p>
